...
Do I fear spreading myself too thin while trying to be everything all in parallel? Yes. That’s actually the recipe for unsuccess, because to “be successful” instead, you’d generally want to “[chisel away](https://www.instagram.com/reel/DNarR2Ktog6/)” distractions and noise to become deeply focused on an activity, make progress and eventually become great at it.
...
(function() {
  const channels = [
    ...
    { name: "SmarterEveryDay", handle: "@smartereveryday" },
    { name: "Answer in Progress", handle: "@answerinprogress" },
    { name: "Howtown", handle: "@Howtown" },
    { name: "Vox", handle: "@Vox" },
    { name: "TED-Ed", handle: "@TEDEd" },
    { name: "Stuff Made Here", handle: "@StuffMadeHere" }
  ];
...
I also created a private "listen later" playlist (like Watch Later for YouTube) to save music I want to listen to but don't have time for right now. Then, every time I listen to a new song from there, I place it into one or more of the playlists I find more appropriate for that song's vibe and genre and remove it from the listen later playlist. And of course, I leave out the ones I don't enjoy. I've gotten quite good at determining whether or not I like a song based only on my first listen, as well as identifying the specific vibe it gives me.
