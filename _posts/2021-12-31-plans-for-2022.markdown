...
To see what I actually achieved, I've checked the list like below with <span style="color: #52d631; font-weight: bold;" >green</span> tick marks and <span style="color: red; font-weight: bold;" >red</span> lines:
...
### <span class="material-icons-outlined">cancel</span> What I haven't done
...
-	work with my Unity video game and actually make some level prototypes and music for it that works
