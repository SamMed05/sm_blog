...
Many things happened in the world this year.

This time, though, I won't discuss any international event here (you can already find everything on the web) and focus instead on my personal experiences.
...
This list was indicative, since in reality I didn't take it too rigidly.-In general, I committed to simply doing useful things, but not necessarily what was on the list you see above. I've still achieved many of the goals I had planned for last year, though. As last year, I'll start by explaining the "failures" first.
...
In May we also did our first school trip of *superiori* (high school), since in the previous two years the pandemic had prevented it from happening. We went to Rome for three days, and I had a great time staying there with my classmates and teachers while visiting the capital of our state 🇮🇹.
...
If you read my list from last year, I had written "*probably no gym*", but surprisingly, I instead decided to finally join it. I worked out for about 6 months (excluding vacations), combining it with a more balanced diet, and it has been a great experience. My weight increased by nearly two kilograms, and I tracked all of my workouts using the fantastic app *Jefit* (which I highly recommend to anyone who goes to the gym).
...
I fell in love with the music of OneRepublic and they are now my favorite artists together with Ludovico Einaudi 💖.
...
-	<input type="checkbox">increase my visibility online
-	<input type="checkbox">continue to actively participate in school activities, projects and representation
- <input type="checkbox">get the driving license
- <input type="checkbox">find a way to start earning money and become economically more independent
-	<input type="checkbox">learn Manim
-	<input type="checkbox">start using Notion
-	<input type="checkbox">listen to more music, read more books, watch more films, play more video games
-	<input type="checkbox">keep having an healthy life
-	<input type="checkbox">enjoy life more

Next year I'll turn 18 and it will be an important moment of my life. As I wrote in the list, I'll become a little more independent and I'll probably look for a job in the summer of find another way to earn some money.

I hope to enjoy 2023 as much as 2022 (if not more), and in the meantime, I wish you all a happy new year! 🎉🎇
